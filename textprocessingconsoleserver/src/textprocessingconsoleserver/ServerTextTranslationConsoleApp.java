...
/**
 * This server class launch application using TCP for text translation in console.
 * 
 * This claass will translate the text input from server to
 * target multiligual text (Bahasa Malaysia, Arabic, Korean).
 * 
		...
		translate.createData();
				...
				try
				{
					...
					while (true) {
						...
						// if client input target language is Bahasa Malaysia
						if(languageChoice == 1)
						{
