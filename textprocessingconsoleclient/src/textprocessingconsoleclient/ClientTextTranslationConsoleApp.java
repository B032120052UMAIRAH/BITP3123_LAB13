package textprocessingconsoleclient;
...
/**
 * The client-side application should send an English text and the target translated language.
 *  
 * Menu will be displayed for client to make choice of target language.
 * 
...
public class ClientTextTranslationConsoleApp {
	...
	{	
		...
		System.out.println("");
		System.out.println("--------------------------------------------------------");
		System.out.println("Please select multiligual text language for translation:");
		System.out.println("--------------------------------------------------------");
