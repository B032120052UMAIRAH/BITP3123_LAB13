 ...
 * where client enter the input English text for translation to selected target language via button.
...
public class ClientTextTranslateFrame extends JFrame implements ActionListener{
	...
	public ClientTextTranslateFrame()
	{
		...
		this.title = new JLabel("Text For Translate :");
		...
		bm.setBackground(new Color(128, 128, 192));
		this.arb = new JButton("Arabic");
		arb.setBackground(new Color(128, 128, 192));
		this.krn = new JButton("Korean");
		krn.setBackground(new Color(128, 128, 192));
	...
	{
		JPanel panel = new JPanel();
		bm.setFont(new Font("Segoe UI Semibold", Font.BOLD, 20));
		arb.setFont(new Font("Segoe UI Semibold", Font.BOLD, 20));
		krn.setFont(new Font("Segoe UI Semibold", Font.PLAIN, 20));
		bm.setOpaque(true);
		arb.setOpaque(true);
		krn.setOpaque(true);
		panel.add(bm);
